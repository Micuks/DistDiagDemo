    ...
    const renderWorkflowGuide = () => (
        <Card style={{ marginBottom: 24 }}>
            ...
            <Space direction="vertical">
                <Text>To get the most out of the training process:</Text>
                <ol>
                    <li>
                        Start by creating a workload in Control Panel (with or without
                        anomalies)
                    </li>
                    ...
                    <li>
                        Once trained, view model performance and use it for anomaly
                        detection
                    </li>
                </ol>
            </Space>
            ...
            <Row justify="space-between">
                ...
                <Col>
                    <Button type="default" onClick={() => navigate("/metrics")}>
        ...
        if (activeAnomalies && activeAnomalies.length > 0) {
            return (
                <Alert
                    ...
                    description={
                        <Text>
                            There are currently {activeAnomalies.length} active anomalies
                            in the system. This is a good opportunity to collect anomaly
                            training data.
                        </Text>
                    }
                    type="warning"
